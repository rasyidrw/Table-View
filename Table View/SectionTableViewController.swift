...
class SectionTableViewController: UITableViewController {
    ...
    let province = ["Banten", "Jawa Barat", "Jawa Tengah"]
    let city = [["Tangerang", "Tangerang Selatan", "Serang"],
                ["Bogor", "Bandung", "Sukabumi"],
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = city[indexPath.section][indexPath.row]
